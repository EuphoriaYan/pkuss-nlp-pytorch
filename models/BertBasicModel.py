    ...
    def from_pretrained(cls, pretrained_model_name, input_configs=None, state_dict=None, cache_dir=None, *inputs, **kwargs):
        ...
        def cached_path(filename):
            ...
            if os.path.exists(filename):
                ...
                # Something unknown
                raise ValueError("unable to parse {} as a local path".format(filename))
        ...
        try:
            ...
            logger.error(
                "We assumed '{}' was a path but couldn't find any file "
                "associated to this path.".format(archive_file))
            return None
